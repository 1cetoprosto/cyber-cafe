...
class ProductDetailsViewController: UIViewController {
    ...
    let productTextfield: UITextField = {
        ...
        textField.placeholder = "Enter product's name"
...
//    var newModel = true
    ...
    func setConstraints() {
        ...
        let productStackView = UIStackView(arrangedSubviews: [productLabel,
                                                           productTextfield,
                                                           priceLabel,
                                                           priceTextfield,
                                                           buttonStackView],
    ...
    @objc func saveAction(param: UIButton) {
        ...
        if productPrice.id.isEmpty {
            ...
            DomainDatabaseService.shared.saveProductsPrice(productPrice: productPrice) { success in
                if !success {
                    PopupFactory.showPopup(title: "Помилка", description: "Не вдалось записати productPrice") { }
                }
            }
        } else {
