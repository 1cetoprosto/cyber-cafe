...
class OrdersTableViewCell: UITableViewCell {
    ...
    lazy var productsName = createOrdersLabel(text: "05.09.21", font: .avenirNext20(), aligment: .left)
    lazy var ordersSum = createOrdersLabel(text: "640", font: .avenirNext14(), aligment: .right)
    lazy var ordersLabel = createOrdersLabel(text: "Plan:", font: .avenirNext14(), aligment: .left)
    ...
    func setConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            productsName.leadingAnchor.constraint(equalTo: backgroundViewCell.leadingAnchor, constant: 16),
...
//            cashSum.centerYAnchor.constraint(equalTo: backgroundViewCell.centerYAnchor),
        ...
        let ordersStackView = UIStackView(arrangedSubviews: [ordersLabel, ordersSum],
                                         axis: .horizontal,
                                         spacing: 5,
                                         distribution: .fillEqually)
        ...
        NSLayoutConstraint.activate([
            ordersStackView.bottomAnchor.constraint(equalTo: backgroundViewCell.bottomAnchor, constant: 0),
//            ordersStackView.leadingAnchor.constraint(equalTo: productsName.trailingAnchor, constant: 5),
            ordersStackView.trailingAnchor.constraint(equalTo: backgroundViewCell.trailingAnchor, constant: -30),
