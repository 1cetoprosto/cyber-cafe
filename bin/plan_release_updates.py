...
NEW_ISSUES = [
    {
        ...
        "body": (
            ...
            "- docs/internal/DEV_IMPLEMENTATION_GUIDE.md\n"
            "- docs/internal/ARCHITECTURE_AND_LOGIC.md\n"
            "- docs/internal/REPORTS.md\n\n"
            "## Expected outcome\n"
            "- \"Current state\" sections reflect v1.1.0 reality (Reports shipped, aggregation layer shipped, balances shipped).\n"
            "- Milestone order in plan files aligns with the current plan: v1.1.1 -> v1.1.2 -> v1.1.3 -> v1.1.4.\n"
