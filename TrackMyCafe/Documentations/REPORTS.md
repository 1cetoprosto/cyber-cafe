...
> **Примітка про версії:**
> Цей документ описує склад і логіку основних звітів (P&L, ABC-аналіз, Динаміка), які **вже реалізовані в додатку з релізу v1.1.0** і доступні в Reports Hub (tab 4 MainTabBarController).
> Далі документ описує **shipped behavior** з мінімальними target-розширеннями (CSV export, додаткові фільтри) — вони можуть з'явитись у наступних патчах (після 1.1.x лінії або в її межах за user ask).
