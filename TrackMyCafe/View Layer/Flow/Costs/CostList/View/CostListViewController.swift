...
class CostListViewController: UIViewController {
    ...
    let tableView: UITableView = {
        ...
        tableView.register(CostsTableViewCell.self, forCellReuseIdentifier: CostsTableViewCell.identifier)
...
extension CostListViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: CostsTableViewCell.identifier,
