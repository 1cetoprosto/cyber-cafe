...
final class OnboardingManager {
    ...
    func startIfNeeded(for feature: OnboardingFeature, on host: UIViewController) {
        ...
        if OnboardingStorage.shared.hasCompleted(feature: feature, versionTag: flow.versionTag) {
            return
        }
        driver.present(on: host, steps: flow.steps.sorted { $0.order < $1.order }) {
            OnboardingStorage.shared.markCompleted(feature: feature, versionTag: flow.versionTag)
        }
    }
}
...
func buildDefaultOnboardingRegistry() {
    ...
    let orderDetailsFlow = OnboardingFlow(
        ...
        steps: [
            OnboardingStepModel(
                targetKey: "dateInput", title: R.string.global.onboardingOrderDetailsDateTitle(),
                message: R.string.global.onboardingOrderDetailsDateMessage(),
                order: 1),
            OnboardingStepModel(
            ...
            OnboardingStepModel(
                targetKey: "productsTable",
                title: R.string.global.onboardingOrderDetailsProductsTitle(),
                message: R.string.global.onboardingOrderDetailsProductsMessage(), order: 3),
            OnboardingStepModel(
                targetKey: "totalsRow", title: R.string.global.onboardingOrderDetailsTotalsTitle(),
                message: R.string.global.onboardingOrderDetailsTotalsMessage(), order: 4),
            OnboardingStepModel(
                targetKey: "cashInput", title: R.string.global.onboardingOrderDetailsCashTitle(),
                message: R.string.global.onboardingOrderDetailsCashMessage(), order: 5
            ),
            OnboardingStepModel(
                targetKey: "cardInput", title: R.string.global.onboardingOrderDetailsCardTitle(),
                message: R.string.global.onboardingOrderDetailsCardMessage(), order: 6
            ),
            OnboardingStepModel(
                targetKey: "saveButton", title: R.string.global.onboardingOrderDetailsSaveTitle(),
                message: R.string.global.onboardingOrderDetailsSaveMessage(), order: 7),
        ]
    )
    ...
    let costDetailsFlow = OnboardingFlow(
        ...
        steps: [
            OnboardingStepModel(
                targetKey: "dateInput", title: R.string.global.onboardingCostDetailsDateTitle(),
                message: R.string.global.onboardingCostDetailsDateMessage(), order: 1),
            OnboardingStepModel(
                targetKey: "nameInput", title: R.string.global.onboardingCostDetailsNameTitle(),
                message: R.string.global.onboardingCostDetailsNameMessage(), order: 2),
            OnboardingStepModel(
                targetKey: "sumInput", title: R.string.global.onboardingCostDetailsSumTitle(),
                message: R.string.global.onboardingCostDetailsSumMessage(), order: 3),
            OnboardingStepModel(
                targetKey: "saveButton", title: R.string.global.onboardingCostDetailsSaveTitle(),
                message: R.string.global.onboardingCostDetailsSaveMessage(), order: 4),
        ]
    )
    ...
    let settingsPriceFlow = OnboardingFlow(
        ...
        steps: [
            OnboardingStepModel(
                targetKey: "priceListCell",
                title: R.string.global.onboardingSettingsPriceListTitle(),
                message: R.string.global.onboardingSettingsPriceListMessage(), order: 1),
            OnboardingStepModel(
                targetKey: "navBarAddProduct",
                title: R.string.global.onboardingSettingsAddProductTitle(),
                message: R.string.global.onboardingSettingsAddProductMessage(),
                order: 2),
        ]
    )
    ...
    let settingsTrackIngredientsFlow = OnboardingFlow(
        feature: .settingsTrackIngredients,
        versionTag: "1.0.10",
        steps: [
            OnboardingStepModel(
                targetKey: "trackIngredientsCell",
                title: R.string.global.onboardingSettingsTrackIngredientsTitle(),
                message: R.string.global.onboardingSettingsTrackIngredientsMessage(),
                order: 1)
        ]
    )
    ...
    OnboardingManager.shared.register(flow: settingsTrackIngredientsFlow)
}
