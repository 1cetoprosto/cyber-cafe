        ...
        get {
            ...
            if !UserDefaults.standard.bool(forKey: kFirstLaunch) {
                ...
                UserDefaults.standard.set(
                    defaultSelection.appearance.rawValue, forKey: kAppearanceStyle)
            ...
            let legacyRaw =
                (UserDefaults.standard.value(forKey: kThemeStyle) as? Int)
                ?? ThemeStyle.system.rawValue
...
struct CoffeeWithMilkTheme: ThemeProtocol {
    ...
    var tabBarUnselectedTint: UIColor {
        ...
        let asset =
            UIColor(named: "TabBarUnselectedTintCoffeeMilk")
            ?? UIColor(red: 109, green: 76, blue: 65)
        return asset
    }
    ...
    var buttonBackground: UIColor {
        color(
            "SecondaryBackgroundCoffeeMilk",
            fallback: UIColor(
                red: 0x2A / 255.0, green: 0x61 / 255.0, blue: 0x46 / 255.0, alpha: 1.0))  // #2A6146
    }

    var buttonText: UIColor {
        color("ButtonTextCoffeeMilk", fallback: .white)
    }
}
