...
enum Typography {
    ...
    static let callout = FontPalette.avenir(.callout, weight: .regular)
    static let calloutDemi = FontPalette.avenir(.callout, weight: .demiBold)
    static let body = FontPalette.avenir(.body, weight: .regular)
    static let bodyMedium = FontPalette.avenir(.body, weight: .medium)
    static let bodyDemiBold = FontPalette.avenir(.body, weight: .demiBold)
    ...
    static let title1 = FontPalette.avenir(.title1, weight: .regular)
    static let title1DemiBold = FontPalette.avenir(.title1, weight: .demiBold)
    static let title1Bold = FontPalette.avenir(.title1, weight: .bold)
    static let largeTitle = FontPalette.avenir(.largeTitle, weight: .regular)
    static let largeTitleDemiBold = FontPalette.avenir(.largeTitle, weight: .demiBold)
    static let largeTitleBold = FontPalette.avenir(.largeTitle, weight: .bold)
}
